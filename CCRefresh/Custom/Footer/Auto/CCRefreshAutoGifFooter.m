...
#import "CCRefreshAutoGifFooter.h"

@interface CCRefreshAutoGifFooter()
{
...
@implementation CCRefreshAutoGifFooter
#pragma mark - 懒加载
- (UIImageView *)gifView
{
    if (!_gifView) {
...
- (void)placeSubviews
{
    ...
    if (self.isRefreshingTitleHidden) {
        ...
        self.gifView.CCW = self.CCW * 0.5 - self.labelLeftInset - self.stateLabel.cc_textWidth * 0.5;
    }
}
