...
@interface CCDIYAutoFooter()
@property (weak, nonatomic) UILabel *label;
@property (weak, nonatomic) UISwitch *s;
@property (weak, nonatomic) UIActivityIndicatorView *loading;
@end

@implementation CCDIYAutoFooter
#pragma mark - 重写方法
...
- (void)placeSubviews
{
    ...
    self.s.center = CGPointMake(self.CCW - 20, self.CCH - 20);
    
    self.loading.center = CGPointMake(30, self.CCH * 0.5);
}
